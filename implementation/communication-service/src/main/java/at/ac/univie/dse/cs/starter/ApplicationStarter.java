...
public class ApplicationStarter {
    ...
    protected static ServerStatusManager listenerStatusManager;
    ...
    protected static UdpServerRequestHandler buildUDPServerRequestHandler(Invoker invoker){
        listenerStatusManager = new ServerStatusManager();
        String serverIpAddress = applicationPropertiesCache.getProperty(PropertiesKeys.UDP.LISTENER_IP_ADDRESS);
        int serverSocketTimeout = applicationPropertiesCache.getIntProperty(PropertiesKeys.UDP.LISTENER_SOCKET_TIMEOUT);
        ...
        return ServerRequestHandlerBuilder.buildServerRequestHandler(entriesMarshallingService,serverIpAddress,serverPort,executorServiceServerThreads,invoker,serverRequestQueueSize,new LinkedBlockingQueue<>(),udpPacketSize,listenerStatusManager,serverSocketTimeout);
    }
